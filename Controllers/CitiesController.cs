...
namespace MvcCodeFirst.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            {
                items.Add(new SelectListItem { Text = p.ProvinceName, Value = p.ProvinceCode });
            }
        ...
        public async Task<IActionResult> Create([Bind("CityId,CityName,Population,ProvinceCode")] City city)
        {
            ...
            {
                city.Province = _context.Provinces.Find(city.ProvinceCode);
                _context.Add(city);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var provinceList = await _context.Provinces.ToListAsync();
            if (provinceList == null)
            {
                provinceList = new List<Province>();
            }
